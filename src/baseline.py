...
MODEL_REGISTRY_NAME = os.getenv("MODEL_REGISTRY_NAME", f"fraud-detection-{MODEL_VERSION}")
...
with mlflow.start_run(run_name="fraud_v1_baseline_training"):
    ...
    mlflow.log_param("class_weight_ratio", f"{class_weight[0]:.2f}:{class_weight[1]:.2f}")
